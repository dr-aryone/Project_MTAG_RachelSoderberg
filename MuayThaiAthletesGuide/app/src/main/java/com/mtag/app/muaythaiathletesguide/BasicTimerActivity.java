...
public class BasicTimerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        airhornPlayer = MediaPlayer.create(BasicTimerActivity.this, R.raw.airhorn);
        beeppingPlayer = MediaPlayer.create(BasicTimerActivity.this, R.raw.beepping);
        boxingarenaPlayer = MediaPlayer.create(BasicTimerActivity.this, R.raw.boxingarena);
        shipbellPlayer = MediaPlayer.create(BasicTimerActivity.this, R.raw.shipbell); // Unused
        tingPlayer = MediaPlayer.create(BasicTimerActivity.this, R.raw.ting);
    ...
    private void runBasicTimer() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (running) {
                    seconds++;
                    if (seconds == timeCap - 3 || seconds == timeCap - 2 || seconds == timeCap - 1)
