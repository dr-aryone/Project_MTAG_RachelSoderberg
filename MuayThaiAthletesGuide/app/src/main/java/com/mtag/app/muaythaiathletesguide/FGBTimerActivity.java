...
public class FGBTimerActivity extends Activity { // implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerSpinner.setSelection(adapter.getPosition("Fight Gone Bad"));
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int timerPos, long id) {
                ...
                switch (timerPos) {
                    case 0: // Basic Stopwatch: Count from 0:00:00 to 99:59:59 (or cap)
                        ...
                        timeCap = 6000;
                        startActivity(new Intent(FGBTimerActivity.this, BasicTimerActivity.class));
                        break;
                    case 1: // Countdown: Count from 99:59:59 (or cap) to 0:00:00
                        onDestroy();
                        running = false;
                        timeCap = 6000;
                        startActivity(new Intent(FGBTimerActivity.this, CountdownTimerActivity.class));
                        break;
                    case 2: // Tabata: Beep every 20th and 30th second. Reset to 0:00:00 on each 30th second
                        onDestroy();
                        running = false;
                        timeCap = 6000;
                        startActivity(new Intent(FGBTimerActivity.this, TabataTimerActivity.class));
                        break;
                    ...
                    case 4: // "3 On 1 Off": Beep every 3rd and 4th minute
                        ...
                        running = false;
                        timeCap = 6000;
                        startActivity(new Intent(FGBTimerActivity.this, ThreeOnTimerActivity.class));
                        break;
                    case 5: // "5 On 1 Off": Beep every 5th and 6th minute
                        onDestroy();
                        running = false;
                        timeCap = 6000;
                        startActivity(new Intent(FGBTimerActivity.this, FiveOnTimerActivity.class));
                        break;
                    default:
                        running = false;
                        seconds = 0;
